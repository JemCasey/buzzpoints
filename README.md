...
See [the Vercel documentation](https://vercel.com/docs/frameworks/nextjs) for instructions on how to deploy using Vercel. You may have to set modify the Node.js version of the build to be 20.x in the package (since this is what the package uses).
